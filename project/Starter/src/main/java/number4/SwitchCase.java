...
public class SwitchCase {
    ...
    public static void main(String[] args) {
        ...
        // На 15 строке создаем конструкцию многозначного выбора, переключатель - switch,
        // которому в качестве выражения-селектора, передаем переменную - number.
        switch (number) { // (number) — выражение-селектор.
            // В теле переключателя switch-case, на 20 и 25 строках,
            ...
            // На 31 строке создаем (необязательный) оператор default, тело которого выполняется в случае,
