package Lectii.lectia8n3.utility;
...
import Lectii.lectia8n3.soccer.Game;
import Lectii.lectia8n3.soccer.Goal;
import Lectii.lectia8n3.soccer.Team;
...
public class GameUtils {
    ...
    public static void addGameGoals(Game currGame) {
        ...
        if (currGame.goals == null) {
            currGame.goals = new Goal[(int) (Math.random() * 10)];
        }
